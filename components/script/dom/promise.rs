...
use js::jsapi::{JS_GetContext, JS_GetFunctionObject, JS_GetObjectRuntime, JS_NewFunction};
use js::jsapi::{JSAutoCompartment, JSContext, JSObject, MutableHandleObject};
